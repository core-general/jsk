...
import net.gcardone.junidecode.fixes.*;

/**
 * Character map for Unicode characters with codepoint U+04xx.
 *
 * @author Giuseppe Cardone https://github.com/gcardone/junidecode
 * @version 0.1
 * <p>
 * Changes: changed some russian code points to better resemble russian translation
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public class JunidecodeFixed {
    /**
