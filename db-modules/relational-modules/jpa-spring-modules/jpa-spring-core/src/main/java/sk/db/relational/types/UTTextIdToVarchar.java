...
public class UTTextIdToVarchar
    ...
    public void setParameterValues(Properties parameters) {
        try {
            ...
            throw new HibernateException(
                    "Class doesnt have string constructor " + Cc.joinMap(parameters.entrySet().stream().collect(Cc.toMEntry())),
                    e);
        }
    }
    ...
    public Object fromStringValue(CharSequence sequence) throws HibernateException {
        return O.ofNull(sequence).map($ -> creator.apply($.toString())).orElse(null);
    }
}
