 ...
 *
 * JSK change 1: added volatile and sycnhronized on all appropriate fields and methods, otherwise conflicts could occur easily.
 *
...
public final class Parameters {
    ...
    private static volatile Map<String, List<URL>> urlsByApplications;
    private static volatile Map<String, List<String>> applicationsByAggregationApplications;

    private static volatile FilterConfig filterConfig;
    private static volatile ServletContext servletContext;
    private static volatile String lastConnectUrl;
    private static volatile Properties lastConnectInfo;
    private static volatile boolean dnsLookupsDisabled;

    private Parameters() {
        super();
    }

    public static synchronized void initialize(FilterConfig config) {
        filterConfig = config;
        if (config != null) {
    ...
    public static synchronized void initJdbcDriverParameters(String connectUrl, Properties connectInfo) {
    ...
    public static synchronized String getLastConnectUrl() {
        return lastConnectUrl;
    }

    public static synchronized Properties getLastConnectInfo() {
     ...
     */
    public static synchronized Map<String, List<URL>> getCollectorUrlsByApplications() throws IOException {
    ...
    public static synchronized Map<String, List<String>> getApplicationsByAggregationApplication()
            throws IOException {
    ...
    public static synchronized void addCollectorApplication(String application, List<URL> urls)
            throws IOException {
    ...
    public static synchronized void addCollectorAggregationApplication(String aggregationApplication,
    ...
    public static synchronized void removeCollectorApplication(String application) throws IOException {
        assert application != null;
        // initialisation si besoin
        getCollectorUrlsByApplications();
    ...
    public static synchronized File getCollectorApplicationsFile() {
        return new File(getStorageDirectory(""), COLLECTOR_APPLICATIONS_FILENAME);
    }

    public static synchronized List<URL> parseUrls(String value) throws MalformedURLException {
    ...
    public static synchronized String getMonitoringPath() {
     ...
     */
    public static synchronized String getResourcePath(String fileName) {
     ...
     */
    public static synchronized int getResolutionSeconds() {
     ...
     */
    public static synchronized File getStorageDirectory(String application) {
     ...
     * @return boolean
     */
    public static synchronized boolean isNoDatabase() {
     ...
     * @return boolean
     */
    public static synchronized boolean isCounterHidden(String counterName) {
     ...
     */
    public static synchronized String getCurrentApplication() {
    ...
    public static synchronized String getContextPath(ServletContext context) {
     ...
     */
    public static synchronized String getParameterValue(Parameter parameter) {
        assert parameter != null;
        final String name = parameter.getCode();
        return getParameterValueByName(name);
    }

    public static synchronized String getParameterValueByName(String parameterName) {
        ...
        if (servletContext != null) {
            ...
            // issue 463: in a ServletContextListener, it's also possible to call servletContext.setAttribute("javamelody.log",
            // "true"); for example
